...
function main(): void {
  ...
  const buffers: IBuffer = initBuffers(gl);
...
//
function initBuffers(gl: WebGLRenderingContext): IBuffer {
...
// Draw the scene.
//
function drawScene(gl: WebGLRenderingContext, programInfo: any, buffers: IBuffer): void {
